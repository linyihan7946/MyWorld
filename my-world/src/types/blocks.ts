...
export const BLOCK_REGISTRY: Record<number, BlockDefinition> = {
  ...
  [BlockType.COBBLESTONE_STAIRS]: { id: BlockType.COBBLESTONE_STAIRS, name: '圆石楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 6 } },
  [BlockType.STONE_BRICK_STAIRS]: { id: BlockType.STONE_BRICK_STAIRS, name: '石砖楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 60 } },
  [BlockType.BRICK_STAIRS]: { id: BlockType.BRICK_STAIRS, name: '砖楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 62 } },
  [BlockType.OAK_STAIRS]: { id: BlockType.OAK_STAIRS, name: '橡木楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 7 } },
  [BlockType.SPRUCE_STAIRS]: { id: BlockType.SPRUCE_STAIRS, name: '云杉楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 94 } },
  [BlockType.BIRCH_STAIRS]: { id: BlockType.BIRCH_STAIRS, name: '白桦楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 97 } },
  [BlockType.SANDSTONE_STAIRS]: { id: BlockType.SANDSTONE_STAIRS, name: '砂岩楼梯', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 13 } },
  ...
  // Slabs
  [BlockType.STONE_SLAB]: { id: BlockType.STONE_SLAB, name: '石头台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 1 } },
  [BlockType.COBBLESTONE_SLAB]: { id: BlockType.COBBLESTONE_SLAB, name: '圆石台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 6 } },
  [BlockType.STONE_BRICK_SLAB]: { id: BlockType.STONE_BRICK_SLAB, name: '石砖台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 60 } },
  [BlockType.BRICK_SLAB]: { id: BlockType.BRICK_SLAB, name: '砖台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 62 } },
  [BlockType.OAK_SLAB]: { id: BlockType.OAK_SLAB, name: '橡木台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 7 } },
  [BlockType.SPRUCE_SLAB]: { id: BlockType.SPRUCE_SLAB, name: '云杉台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 94 } },
  [BlockType.BIRCH_SLAB]: { id: BlockType.BIRCH_SLAB, name: '白桦台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 97 } },
  [BlockType.SANDSTONE_SLAB]: { id: BlockType.SANDSTONE_SLAB, name: '砂岩台阶', solid: true, transparent: false, breakable: true, hardness: 11, textures: { all: 13 } },

  // Fences
  [BlockType.OAK_FENCE]: { id: BlockType.OAK_FENCE, name: '橡木栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 7 } },
  [BlockType.SPRUCE_FENCE]: { id: BlockType.SPRUCE_FENCE, name: '云杉栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 94 } },
  [BlockType.BIRCH_FENCE]: { id: BlockType.BIRCH_FENCE, name: '白桦栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 97 } },
  [BlockType.JUNGLE_FENCE]: { id: BlockType.JUNGLE_FENCE, name: '丛林栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 100 } },
  [BlockType.ACACIA_FENCE]: { id: BlockType.ACACIA_FENCE, name: '金合欢栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 103 } },
  [BlockType.DARK_OAK_FENCE]: { id: BlockType.DARK_OAK_FENCE, name: '深色橡木栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 106 } },
  [BlockType.NETHER_BRICK_FENCE]: { id: BlockType.NETHER_BRICK_FENCE, name: '下界砖栅栏', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 42 } },

  // Walls
  [BlockType.COBBLESTONE_WALL]: { id: BlockType.COBBLESTONE_WALL, name: '圆石墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 6 } },
  [BlockType.MOSSY_COBBLESTONE_WALL]: { id: BlockType.MOSSY_COBBLESTONE_WALL, name: '苔圆石墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 92 } },
  [BlockType.STONE_BRICK_WALL]: { id: BlockType.STONE_BRICK_WALL, name: '石砖墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 60 } },
  [BlockType.BRICK_WALL]: { id: BlockType.BRICK_WALL, name: '砖墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 62 } },
  [BlockType.ANDESITE_WALL]: { id: BlockType.ANDESITE_WALL, name: '安山岩墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 89 } },
  [BlockType.DIORITE_WALL]: { id: BlockType.DIORITE_WALL, name: '闪长岩墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 87 } },
  [BlockType.GRANITE_WALL]: { id: BlockType.GRANITE_WALL, name: '花岗岩墙', solid: true, transparent: true, breakable: true, hardness: 11, textures: { all: 85 } },
